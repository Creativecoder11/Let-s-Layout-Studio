...
import logo from '@/assets/img/logo/LLS - white.svg';
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 mb-50">
              <div className="tp-footer-2-widget footer-col-2-1">
                ...
                <div className="tp-footer-2-widget-text">
                  <p>Let’s Layout Studio is Your Complete Creative Partner.</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-xl-3 col-lg-5 col-md-6 mb-50">
              <div className="tp-footer-2-widget footer-col-2-3">
                ...
                <div className="tp-footer-2-contact-item">
                  <span><a href="https://www.google.com/maps/@23.8223596,90.3656686,15z?entry=ttu" target="_blank">Aziz Market 95/3, Pallabi, Dhaka Cantonment 1206</a></span>
                </div>
                <div className="tp-footer-2-contact-item">
                  <span><a href="tel:+8801931927452">P: +8801931-927452</a></span>
                </div>
                <div className="tp-footer-2-contact-item">
                  <span><a href="mailto:contact@Let's Layout Studio.com">E: hey@letslayoutstudio.com</a></span>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-xl-4 col-lg-5">
              <div className="tp-copyright-2-left text-center text-lg-start">
                <p>All rights reserved — {new Date().getFullYear()} © Nur Mohammad Kawser</p>
              </div>
            </div>
            <div className="col-xl-8 col-lg-7">
              <div className="tp-copyright-2-social text-center text-lg-end">
                <a className="mb-10" href="#">Facebook</a>
